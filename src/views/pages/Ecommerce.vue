      ...
      <div class="container">
        <div class="md-layout">
          ...
          >
            ...
            <h4 class="title">Discover, collect and sell extraordinary NFTs22</h4>
            <md-button class="md-button md-theme-default md-behance md-round">
              Explore The Marketplace44
            </md-button>
          </div>
        </div>
      </div>
    ...
    <div class="main main-raised">
      <div class="section">
        <div class="container">
          ...
          <h2 class="section-title text-center">Live Auctions22</h2>
          <div class="md-layout">
          ...
          <div class="section pb-0">
            <div class="container">
              <h2 class="section-title text-center">Top Sellers11</h2>
              <div class="md-layout">
                <div
      ...
      <div class="section pb-0">
        <div class="container">
          <h2 class="section-title text-center">Explore The Marketplace55</h2>
          <div class="md-layout">
